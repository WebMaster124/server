...
var DraftListingPage = /** @class */ (function () {
    ...
    DraftListingPage.prototype.checkAddress = function () {
        var _this = this;
        try {
            if (this.localItem == null) {
            }
                ...
                var business_address = {
                    ...
                    this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/product/check-address', business_address, function (response) {
    ...
    DraftListingPage.prototype.getAllCount = function () {
        var _this = this;
        if (this.localItem == null) {
        }
        else {
