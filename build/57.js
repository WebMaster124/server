...
var ContactUsPage = /** @class */ (function () {
    ...
    //show contact data.
    ContactUsPage.prototype.showContact = function () {
        var _this = this;
        var contact_listing = {
//            id: this.navParams.data.id
        };
//        this.infoService.showLoading();
        this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/contact/view-contact' , contact_listing, function (response) {          
            if (response.status == "success") {
//				console.log(response);
//				alert(response.data.phone_no);
                _this.contact_data = response;
            }
            else {
