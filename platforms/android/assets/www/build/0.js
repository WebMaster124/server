...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewpurchaseUserlistPageModule", function() { return ViewpurchaseUserlistPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__viewpurchase_userlist__ = __webpack_require__(821);
...
var ViewpurchaseUserlistPageModule = /** @class */ (function () {
    function ViewpurchaseUserlistPageModule() {
    }
    ViewpurchaseUserlistPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__viewpurchase_userlist__["a" /* ViewpurchaseUserlistPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__viewpurchase_userlist__["a" /* ViewpurchaseUserlistPage */]),
    ...
    ], ViewpurchaseUserlistPageModule);
    return ViewpurchaseUserlistPageModule;
}());

//# sourceMappingURL=viewpurchase-userlist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewpurchaseUserlistPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
...
var ViewpurchaseUserlistPage = /** @class */ (function () {
    function ViewpurchaseUserlistPage(googleanalytics, alertCtrl, plt, infoService, navCtrl, navParams) {
        var _this = this;
        ...
        if (this.plt.is('core') == false && this.plt.is('mobileweb') == false) {
            this.googleanalytics.startTrackerWithId('UA-127414417-1').then(function () {
                _this.googleanalytics.trackView('ViewpurchaseList');
            }).catch(function (e) { return console.log('Error starting GoogleAnalytics', e); });
        }
    }
    ViewpurchaseUserlistPage.prototype.ionViewWillEnter = function () {
    ...
    ViewpurchaseUserlistPage.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    ViewpurchaseUserlistPage.prototype.showUserList = function () {
        var _this = this;
        var pro_view = {
            product_id: this.navParams.data.id
        };
        this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/seller/view-product-purchase-user-list', pro_view, function (response) {
            _this.showpurchaseData = response.user_list;
        }, function (error) {
            console.log(error);
        });
    };
    ViewpurchaseUserlistPage.prototype.changeOrderStatus = function (val_orderStatus, val_buyerid, val_productid, val_orderid) {
        var _this = this;
        if (val_orderStatus == "")
            return false;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/checkout/change-order-product-status', order_status, function (response) {
    ...
    ViewpurchaseUserlistPage.prototype.changeStatusToPaid = function (val_buyerid, val_productid, val_orderid) {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Change Status',
    ...
    return ViewpurchaseUserlistPage;
}());

//# sourceMappingURL=viewpurchase-userlist.js.map
