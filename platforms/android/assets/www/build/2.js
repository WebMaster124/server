...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonalizedfeedbackPageModule", function() { return PersonalizedfeedbackPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__personalizedfeedback__ = __webpack_require__(817);
...
var PersonalizedfeedbackPageModule = /** @class */ (function () {
    function PersonalizedfeedbackPageModule() {
    }
    PersonalizedfeedbackPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__personalizedfeedback__["a" /* PersonalizedfeedbackPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__personalizedfeedback__["a" /* PersonalizedfeedbackPage */]),
    ...
    ], PersonalizedfeedbackPageModule);
    return PersonalizedfeedbackPageModule;
}());

//# sourceMappingURL=personalizedfeedback.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PersonalizedfeedbackPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
 ...
 */
var PersonalizedfeedbackPage = /** @class */ (function () {
    function PersonalizedfeedbackPage(googleanalytics, plt, infoService, navCtrl, navParams) {
        var _this = this;
        ...
        this.Userdata = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].localItem;
        if (this.plt.is('core') == false && this.plt.is('mobileweb') == false) {
            this.googleanalytics.startTrackerWithId('UA-127414417-1').then(function () {
                _this.googleanalytics.trackView('ReplytoFeedbackReceived');
            }).catch(function (e) { return console.log('Error starting GoogleAnalytics', e); });
        }
    }
    PersonalizedfeedbackPage.prototype.ionViewWillEnter = function () {
    ...
    PersonalizedfeedbackPage.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    PersonalizedfeedbackPage.prototype.showReplyfeedback = function () {
        var _this = this;
        var reply_data = {
        ...
        try {
            ...
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/feedback/reply-feedback-list', reply_data, function (response) {
                _this.replyFeedbackData = response.feedback.data;
    ...
    PersonalizedfeedbackPage.prototype.getServerData = function (event) {
        var _this = this;
        ...
        try {
            this.infoService.showLoading();
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/feedback/reply-feedback-list?page=' + event, replydata_pagination, function (response) {
                _this.replyFeedbackData = response.feedback.data;
                _this.infoService.hideLoading();
            }, function (error) {
                console.log(error);
    ...
    PersonalizedfeedbackPage.prototype.goToLeavefeedback = function (valseller_id, valproduct_id, valbuyer_id, valproduct_title, valbuyer_name, valphotos, valorderId) {
        var feedbackData = {
    ...
    return PersonalizedfeedbackPage;
}());

//# sourceMappingURL=personalizedfeedback.js.map
