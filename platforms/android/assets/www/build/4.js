...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_data__ = __webpack_require__(795);
...
var SearchDataPageModule = /** @class */ (function () {
    function SearchDataPageModule() {
    }
    SearchDataPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__search_data__["a" /* SearchDataPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__search_data__["a" /* SearchDataPage */]),
    ...
    return SearchDataPageModule;
}());

//# sourceMappingURL=search-data.module.js.map
...
var SearchDataPage = /** @class */ (function () {
    function SearchDataPage(plt, infoService, navCtrl, navParams) {
        this.plt = plt;
    ...
    SearchDataPage.prototype.ionViewWillEnter = function () {
    ...
    SearchDataPage.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    SearchDataPage.prototype.showSearchData = function () {
        var _this = this;
        try {
            var convertdecode = atob(this.getData_decode);
            var convertparse = JSON.parse(convertdecode);
            this.infoService.showLoading();
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/search/home-search', convertparse, function (response) {
    ...
    SearchDataPage.prototype.GoToProDetail = function (val) {
        this.navCtrl.push('ProductDetails', {
            id: val
        });
    };
    SearchDataPage.prototype.GoToSubCat = function (val) {
        this.navCtrl.push('SubCategoryPage', {
            id: val
        });
    };
    SearchDataPage.prototype.saveSearch = function () {
        var _this = this;
        var convertdecode = atob(this.getData_decode);
        var convertparse = JSON.parse(convertdecode);
        var advance_search;
        if (convertparse.category_id == '' || convertparse.category_id == null || convertparse.category_id == 'undefind') {
            advance_search = (_a = {},
                _a['keyword'] = [convertparse.keyword],
                _a);
        }
        else {
            advance_search = (_b = {},
                _b['keyword'] = [convertparse.keyword],
                _b['category_id'] = [convertparse.category_id],
                _b);
        }
