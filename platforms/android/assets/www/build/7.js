...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ParentCategoryPageModule", function() { return ParentCategoryPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parent_category__ = __webpack_require__(778);
...
var ParentCategoryPageModule = /** @class */ (function () {
    function ParentCategoryPageModule() {
    }
    ParentCategoryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__parent_category__["a" /* ParentCategoryPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__parent_category__["a" /* ParentCategoryPage */]),
    ...
    return ParentCategoryPageModule;
}());

//# sourceMappingURL=parent-category.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParentCategoryPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
...
var ParentCategoryPage = /** @class */ (function () {
    function ParentCategoryPage(googleanalytics, plt, infoService, navCtrl, navParams) {
        var _this = this;
        ...
        if (this.plt.is('core') == false && this.plt.is('mobileweb') == false) {
            this.googleanalytics.startTrackerWithId('UA-127414417-1').then(function () {
                _this.googleanalytics.trackView('ParentCategory');
            }).catch(function (e) { return console.log('Error starting GoogleAnalytics', e); });
        }
    }
    ParentCategoryPage.prototype.ionViewWillEnter = function () {
    ...
    ParentCategoryPage.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    ParentCategoryPage.prototype.showParentCat = function () {
        var _this = this;
        try {
            var cat_parent;
            ...
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/product/category-product-list', cat_parent, function (response) {
                _this.parent_data = response;
                $(document).prop('title', _this.parent_data.category.category_name + ' | Dibdaa');
    ...
    ParentCategoryPage.prototype.getServerData = function (event) {
        var _this = this;
        var cat_parent;
        if ($.type(this.navParams.data.id) == 'object')
            cat_parent = this.navParams.data.id;
        ...
        try {
            this.infoService.showLoading();
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/product/category-product-list?page=' + event, cat_parent, function (response) {
                _this.parent_data = response;
                _this.infoService.hideLoading();
    ...
    ParentCategoryPage.prototype.GoToProDetail = function (val) {
        this.navCtrl.push('ProductDetails', {
            id: val
        });
    };
    //Redirect to sub category page.
    ParentCategoryPage.prototype.GoToSubCat = function (val) {
        this.navCtrl.push('SubCategoryPage', {
            id: val
        });
    };
    //show data by type.
    ParentCategoryPage.prototype.showBytype = function (val, val1) {
