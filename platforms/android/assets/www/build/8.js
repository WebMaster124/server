...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_product__ = __webpack_require__(837);
...
var EditProductPageModule = /** @class */ (function () {
    ...
    EditProductPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_product__["a" /* EditProductPage */]),
...
var EditProductPage = /** @class */ (function () {
    function EditProductPage(googleanalytics, alertCtrl, _PHOTO, plt, infoService, navCtrl, navParams) {
        var _this = this;
        ...
        if (this.plt.is('core') == false && this.plt.is('mobileweb') == false) {
            this.googleanalytics.startTrackerWithId('UA-127414417-1').then(function () {
                _this.googleanalytics.trackView('EditProduct');
            }).catch(function (e) { return console.log('Error starting GoogleAnalytics', e); });
            this.userSettings.showCurrentLocation = false;
        }
    }
    EditProductPage.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    EditProductPage.prototype.ionViewDidLoad = function () {
        ...
        try {
            ...
            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/product/view-product-edit', this.view_product_val, function (response) {
                ...
                _this.edit_product_val.status = _this.view_Product.data.status;
    ...
    //Convert To Base64
    EditProductPage.prototype.convertFileToDataURLviaFileReader = function (url, callback) {
    ...
    EditProductPage.prototype.fileSizeLimit = function (min, max) {
    ...
    EditProductPage.prototype.selectImage = function () {
        var _this = this;
        this._PHOTO.selectImage().then(function (data) {
            if (data != '0') {
                if ($('#image_preview div').length < 11) {
                    ...
                    _this.edit_product_val.photos.push(data);
                    $('.close').on('click', function () {
                        $(this).parent().remove();
                    });
                }
    ...
    EditProductPage.prototype.autoCompleteCallback1 = function (selectedData) {
    ...
    EditProductPage.prototype.showFees = function () {
        var _this = this;
        var seller_fees = {
        ...
        this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/setting/seller-fees', seller_fees, function (response) {
            ...
            if (_this.view_Product.data.seller_fee <= 0) {
                var calculate_catPrice = ((_this.view_Product.data.price * parseFloat(_this.view_Product.data.sub_cat_charge)) / 100);
                var insertionfee = 0;
                if (_this.view_Product.data.price > 0.01 && _this.view_Product.data.price <= 3.75) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + 0;
                }
                else if (_this.view_Product.data.price > 3.75 && _this.view_Product.data.price <= 35) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + parseFloat(_this.show_feesData.insert_fee.second);
                }
                else if (_this.view_Product.data.price > 35 && _this.view_Product.data.price <= 90) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + parseFloat(_this.show_feesData.insert_fee.third);
                }
                else if (_this.view_Product.data.price > 90 && _this.view_Product.data.price <= 180) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + parseFloat(_this.show_feesData.insert_fee.four);
                }
                else if (_this.view_Product.data.price > 180 && _this.view_Product.data.price <= 750) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + parseFloat(_this.show_feesData.insert_fee.five);
                }
                else if (_this.view_Product.data.price > 750) {
                    insertionfee = parseFloat(_this.checkbuyitnowfees) + parseFloat(_this.checkinsertaionfees) + parseFloat(_this.show_feesData.insert_fee.six);
                }
                var subtitlesetfees = 0;
                if (_this.view_Product.data.subtitle != null && _this.view_Product.data.subtitle != '')
                    subtitlesetfees = _this.show_feesData.data.subtitle_fee;
                _this.view_Product.data.seller_fee = insertionfee + calculate_catPrice + subtitlesetfees;
            }
        }, function (error) {
            console.log(error);
        });
    };
    EditProductPage.prototype.showDailyfees = function (val) {
        if (val == "" || val == 'No' || val == 'Yes')
            this.daiydealsFees = 0;
        this.calculateFees();
    };
    EditProductPage.prototype.showsubtotalFees = function () {
    ...
    EditProductPage.prototype.showcategoryFees = function () {
        var price_cal;
    ...
    EditProductPage.prototype.showsellDayfees = function (val) {
        if (val == "" || val == null)
            this.sellseasonFees = 0;
        else
    ...
    EditProductPage.prototype.calculateFees = function () {
        var total;
    ...
    EditProductPage.prototype.disableText = function () {
    ...
    EditProductPage.prototype.change_date = function () {
        if ($('#return-accepted').prop('checked') == true)
            this.return_opt = true;
        else
            this.return_opt = false;
    };
    EditProductPage.prototype.showData = function (val) {
        this.view_Product.data.selling_type = val;
    };
    EditProductPage.prototype.showDays = function (val) {
        this.view_Product.data.daily_deal = val;
        this.showDailyfees(val);
    };
    EditProductPage.prototype.other_Payment = function (val) {
    ...
    EditProductPage.prototype.chngeISBN = function (val) {
        ...
        if ($('#image_preview div').length <= 0 && $('#image_preview_append div').length <= 0) {
            ...
            if (size.length > 0) {
                if ($('#Format').val() != "Auction style") {
                    ...
                    if (parseInt(this.edit_product_val.quantity) != tasktotalCount_1) {
            ...
            if (this.detailsData.product_page == 'Unsold') {
                this.edit_product_val.status = 0;
            }
                        ...
                        if (this.edit_product_val.max_price <= parseInt($('#min_price').val()) && this.edit_product_val.max_price != 0) {
                            ...
                            this.infoService.callHttpFunction_post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].serverUrl + 'api/product/edit-product', this.edit_product_val, function (response) {
                                if (response.status == "success") {
                                    ...
                                    var self_this = _this;
                                    setTimeout(function () {
                                        self_this.navCtrl.push('HomePage');
                                        self_this.ifproductedit = false;
                                    }, 2500);
                                }
                                else {
                                    _this.editproductResponse = response;
    ...
    EditProductPage.prototype.closeDiv_Delete = function () {
        $('#dangeralert').addClass('hide');
    };
    EditProductPage.prototype.checkPaypalEmail = function (val) {
        var _this = this;
        var pass_data = {
            paypal_email: val
        };
    ...
    EditProductPage.prototype.checkSaesonDeal = function (val) {
        var _this = this;
        var seasonData = {
            cat_id: val
        };
    ...
    EditProductPage.prototype.checkschldlisting = function (val) {
        if (val == 'yes') {
            $('.selectOptions').attr('disabled', false);
        }
        else if (val == 'no') {
    ...
    EditProductPage.prototype.showDaysSelection = function (val) {
        if (val == "Yes") {
    ...
    EditProductPage.prototype.createCustomspecification = function (val) {
        var _this = this;
    ...
    EditProductPage.prototype.checkCheckboxforsize = function (val, val1) {
        if (val == "Size") {
    ...
    EditProductPage.prototype.setQuantityvalue = function () {
