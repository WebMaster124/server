...
<!-- headerbar -->
    <div class="pageheader">
        ...
        <div class="breadcrumb-wrapper">
            ...
            <ol class="breadcrumb">
                <li class="active">Buyer Invoice Management</li>
            </ol>
        </div>
    </div>
    ...
    <div class="contentpanel">
        ...
        @endif
        <div class="row">
            <form action="{{ action('FaqController@saveFaqCategory') }}" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" required value="{{old('topic_name')}}" class="form-control" id="topic_name" placeholder="Enter Title" name="topic_name">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <!--<button type="button" name="topic_icon" id="topic_icon">choose Icon</button>-->
                                <input type="text" required value="{{old('topic_icon')}}" class="form-control" id="topic_icon" placeholder="Choose Icon" name="topic_icon">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" rows="5" name="topic_desc"> {{old('topic_desc')}}</textarea>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select value="{{old('status')}}" class="form-control" id="sel1" name="status">
