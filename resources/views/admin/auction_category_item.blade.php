...
<!-- headerbar -->
    <div class="pageheader">
        <h2> Number of item By Category wise & Auction Type  <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
    </div>
<?php
		...
		buttons: [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Number of item By Category wise & Auction Type'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Number of item By Category wise & Auction Type'
                        ...
                        } */
						{
							...
							filename:'Data Export - Number of item By Category wise & Auction Type',
							title: null,
                            customize: function ( doc ) {
								doc.content.splice( 0, 0, {
									marginTop:  10,
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Number of item By Category wise & Auction Type',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
