...
<!-- headerbar -->
    <div class="pageheader">
        <h2> Total Deliveries by Category  <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
    </div>
<?php
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="Export">
                        ...
                        <tbody>
                        <?php foreach ($deliveredCategory as $product){ ?>
                        <tr>
                            ...
                            <td>@if($product->selling_type=='Fixed price')
                                    {{$product->price}}
                                @else
                            ...
                            <td>
                                <?php  $types=unserialize($product->shipment_type); ?>
                                @foreach($types as $type)
                                    {{$type}} ,
                                @endforeach
                            </td>
                            <td>{{date('M d,Y',strtotime($product->created_date))}}</td>
                        </tr>
                        <?php  }?>
                        </tbody>
                    </table>
		...
		buttons: [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Total Deliveries by Category'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Total Deliveries by Category'
							...
							filename:'Data Export - Total Deliveries by Category',
							title: null,
                            customize: function ( doc ) {
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Total Deliveries by Category',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
