        ...
        <div class="row">
            <form action="{{ action('FeatureController@editFeatureData') }}" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                 ...
                 <?php //  echo $feature_deal->feature_image;?>
                        <div class="form-group" style="display:none;">
                            <label class="col-sm-3 control-label">Parent Category *:</label>
                            <div class="col-sm-6">
                                <select class="form-control" id="category_ids"  >
                                    <?php
                                    $category=$feature_deal->category_ids;
...
f++;
        ...
        function someFunction(id, value,sub_cat){
        //alert(sub_cat);
            ...
            success:function(data){
				 $('#category_id'+id+'_sub').html(data); 
                                  $('#category_id'+id+'_sub').val(sub_cat);
                                  $('#category_id'+id).val(value);
        ...
        //alert(idArr);
            ...
            success:function(data){
                ...
                $('.main-class .form-group:not(".'+v+'")').hide(); */
                  ...
                  $('#feature_img_edit').on('change', '.category_id', function() {
