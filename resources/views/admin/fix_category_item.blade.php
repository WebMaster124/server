...
<!-- headerbar -->
    <div class="pageheader">
        <h2> Number of item By Category wise & Buy It Now  <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
    </div>
<?php
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="Auction_Type_Export">
                        ...
                        <tbody>
                        <?php foreach ($auctionCategory as $product){ ?>
                        <tr>
		...
		buttons: [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Number of item By Category wise & Buy It Now'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Number of item By Category wise & Buy It Now'
                        ...
                        } */
						{
							...
							filename:'Data Export - Number of item By Category wise & Buy It Now',
							title: null,
                            customize: function ( doc ) {
								doc.content.splice( 0, 0, {
									marginTop:  10,
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Number of item By Category wise & Buy It Now',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
