...
<div class="mainpanel">
    <style>
        ...
        div#table2_wrapper .dataTables_filter {
            display: none;
        }
        .contentpanel .dataTables_filter {
            position: absolute;
            top: 150px;
            right: 35px;
            z-index: 10;
    ...
    <!-- row -->
        <div class="panel panel-default">
            <div class="panel-body">
                <!-- table-responsive -->
                <div class="custom-search text-right dataTables_filter" id="table2_filter">
                    <label>Search:</label>
                ...
                <div class="table-responsive">
                    <table class="table" id="table2">
                        ...
                        <tr>
                            ...
                            <td><?php $f=unserialize($product->fees_details);
                                echo  $f['categories_fees'][0]; ?></td>
...
<script>
    jQuery(document).ready(function() {
			...
			"buttons": [
				{
					...
					buttons: [
								{
								extend: 'excelHtml5',
								title: 'Data Export - Item Listed By Category'
								},
								{
								extend: 'csvHtml5',
								title: 'Data Export - Item Listed By Category'
							...
							filename:'Data Export - Item Listed By Category',
							title: null,
                            customize: function ( doc ) {
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Item Listed By Category',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
        ...
        var T2 = jQuery("#table2").dataTable();
        $('#myInputTextField').keyup(function(){
            T2.fnFilter($(this).val(),1) ;
        });
