...
<!-- headerbar -->
    <div class="pageheader">
        <h2>Paypal Sale Details <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button> </h2>
    </div>
<?php 
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="table2">
                        ...
                        <tbody>
                        <?php foreach ($paypal_product as $product){ ?>
                        <tr>
        ...
        var x=  jQuery('#table2').dataTable({
			 ...
			 "buttons": [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Paypal Sale Details'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Paypal Sale Details'
							...
							filename:'Data Export - Paypal Sale Details',
							title: null,
                            customize: function ( doc ) {
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Paypal Sale Details',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
