...
<!-- headerbar -->
    <div class="pageheader">
        <h2> Total returns, total refunds  <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
    </div>
<?php 
                ...
                <div class="table-responsive">
                    <table class="table" id="table2">
                        ...
                        <tr>
                            ...
                            <th>Item Name</th>
                            <th>User Name</th>
                            <th>Fee Type Listing </th>
                            <th>Fee Type Final Sale Commission</th>
                            <th>Fee Type Final Featured Sales </th>
                            <th>Fee Type Season Deals</th>
                            <th>Type of Query</th>
                            <th>Date of Query on Resolution </th>
                            <th>Quantity</th>
                            <th>Value (AED)</th>
                            <th>Address</th>
                        </tr>
                        ...
                        <tr>
                            <td><?php
                                ...
                                ?></td>
                            <td>{{date('Y-m-d',strtotime($product->sold_date))}}</td>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td>{{$f['categories_fees'][0]}}</td>
                            <td>{{$f['featured_fees'][1]}}</td>
                            <td>{{(isset($f['season_fees'][1])?$f['season_fees'][1]:'-')}}</td>
                            <td>{{$product->question}}</td>
                            <td>{{date('Y-m-d',strtotime($product->query_date))}}</td>
		...
		buttons: [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Total returns, total refunds'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Total returns, total refunds'
							...
							filename:'Data Export - Total returns, total refunds',
							title: null,
                            customize: function ( doc ) {
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Total returns, total refunds',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
