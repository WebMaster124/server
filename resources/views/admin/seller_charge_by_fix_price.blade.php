...
<!-- headerbar -->
    <div class="pageheader">
        <h2> Fees Charged to Sellers by Fixed Price  <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
    </div>
	<?php
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="Export">
                        ...
                        <tbody>
                        <?php foreach ($fees_fix_price as $product){ ?>
                        <tr>
		...
		buttons: [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - Fees Charged to Sellers by Fixed Price'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - Fees Charged to Sellers by Fixed Price'
							...
							filename:'Data Export - Fees Charged to Sellers by Fixed Price',
							title: null,
                            customize: function ( doc ) {
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - Fees Charged to Sellers by Fixed Price',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
