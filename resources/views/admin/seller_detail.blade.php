...
<!-- headerbar -->
    <div class="pageheader">
        <h2> View Seller Details   <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button></h2>
                ...
                <div class="panel table-panel viewdata-user">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#business" data-toggle="tab"><strong>Business Detail</strong></a></li>
                            ...
                            <div class="tab-pane" id="business">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php $payment=unserialize($user->payment_opt); ?>
