...
<!-- headerbar -->
    <div class="pageheader">
        <h2> View Users Log <button class="btn btn-primary" onclick="history.go(-1);"><i style="font-size:10px" class="fa">&#xf060;</i> Go Back </button> </h2>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
            <ol class="breadcrumb">
                <li class="active">view users log</li>
            </ol>
        </div>
    </div>
...
<!--                            <div class="col-md-4" style="margin-top: 5px;">Search by status:</div>
                    ...
                    <table class="table" id="table2">
                        ...
                        <tr>
                            ...
                            <td>{{$user->user_id}}</td>
                            <td>
                             <a href="buyer-details/{{$user->user_id}}">{{ $user->user_name }}</a> </td>
                                
                            <td>{{$user->nationality}}</td>
                            <td>{{$user->ip_address}}</td>
                            <td>{{date('D-M-d,Y',strtotime($user->agreed_on))}}</td>
        ...
        jQuery('#table2').dataTable({
			 ...
			 "buttons": [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - View Users Log'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - View Users Log'
                        ...
                        } */
						{
							...
							filename:'Data Export - View Users Log',
							title: null,
                            customize: function ( doc ) {
								doc.content.splice( 0, 0, {
									marginTop:  10,
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - View Users Log',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
