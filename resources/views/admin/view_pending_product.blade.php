...
<!-- headerbar -->
    <div class="pageheader">
        <h2> View Pending Products list </h2>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
            <ol class="breadcrumb">
                <li class="active">view pending products list</li>
            </ol>
        </div>
    </div>
<?php 
                    ...
                    <table class="table" id="table2">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                if($product->status=='2'){
                                    echo "<center> <a href='change-product-status/$product->id/1/view-pending-product'>Approve</a> </center> &nbsp";
                                    echo "<center><a href='deactive-product-form/$product->id/2/view-pending-product'>Reject</a></center>";
                                }
                                ?>
                            </td>
                        </tr>
        ...
        var x=  jQuery('#table2').dataTable({
			 ...
			 "buttons": [
            {
                ...
                buttons: [
							{
							extend: 'excelHtml5',
							title: 'Data Export - View Pending Products list'
						    },
							{
							extend: 'csvHtml5',
							title: 'Data Export - View Pending Products list'
                        ...
                        } */
						{
							...
							filename:'Data Export - View Pending Products list',
							title: null,
                            customize: function ( doc ) {
								doc.content.splice( 0, 0, {
									marginTop:  10,
								...
								doc.content.splice( 0, 0, {
									...
									columns: [
											{
												text: 'Data Export - View Pending Products list',bold: true
											}
										]	
								});
                                doc.content.splice( 0, 0, {
