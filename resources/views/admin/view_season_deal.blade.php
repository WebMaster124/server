...
<!-- headerbar -->
    <div class="pageheader">
        <h2> View Season Deals </h2>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
            <ol class="breadcrumb">
                <li class="active">view season deals</li>
            </ol>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <h5 class="subtitle mb5"><div class="row">
                        <div class="col-md-3">
                            <a href="{{action('SeasonController@seasonForm')}}" class="btn btn-primary">Add Season Deal</a> </div>
                    </div>
                </h5>
                <br />
				 ...
				 <a href="season/download-jsonfile" class="btn btn-danger">Export to .txt</a>
                    ...
                    <table class="table" id="table2">
                        ...
                        <tr>
                            ...
                            <!--<th>Season Image</th>-->
                            <th>Season Name</th>
                            <th>Season Charges</th>
                            <th>Status</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($season_deals as $deal){ ?>
                        <tr>
                            <td> {{$deal->id}} </td>
                            <td><?php
                                ...
                                ?></td>
<!--                            <td> @if($deal->season_image!='')
                                        <img src="{{asset("/images/season/$deal->season_image")}}" height="auto" width="100">
                                    @else
                                        <img height="auto" width="100" src="{{ asset('/images/placeholder.gif')}}">
                                    @endif</td>-->
                            <td><?php echo $deal->season_name;?></td>
                            <td><?php echo $deal->season_charges;?></td>
                            <td> <?php
                                if($deal->status=='1'){
                            ...
                            <td>
                                <?php
                                if($deal->status=='0'){
                                    echo "<div style='width: 67px;' class='alert well-sm alert-success'><a href='change-season-status/$deal->id'>Active</a> </div> &nbsp;";
                                }
                                if($deal->status=='1'){
                                    echo "<div  style='width: 67px;'  class='alert well-sm alert-danger'> <a href='change-season-status/$deal->id'>Inactive</a> </div> &nbsp;";
                                }
                                else
                                ?>
                                <a href="edit-season/<?php echo $deal->id;?>"><i title="Edit" class="fa fa-edit text-primary" style="font-size: 20px;"></i></a></td>
                        </tr>
                        <?php  } ?>
                        </tbody>
                    </table>
