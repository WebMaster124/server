...
<td style="height: 35px;padding-left: 10px;padding-right: 10px;">
<p>&nbsp; </p>
    <p>Digitally Signed by <strong><?php // echo $user_name; ?></strong> of <?php // echo $nationality; ?> on <?php // echo $date; ?> and the (IP number: <?php // echo $ip_address; ?>  and IP country address: <?php // echo $country; ?> ).</p>
<p>&nbsp; </p>
</td>
