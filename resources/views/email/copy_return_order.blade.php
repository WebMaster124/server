...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
      ...
      color:white;font-weight:normal'>Return order<o:p></o:p></span></h1>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div align=center>
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
        ...
        product {{$product_info->title}},  Order
        ...
        <tr>
            <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              word-wrap: break-word'>
                <?php $image=unserialize($product_info->photos);  ?>
              ...
              color:#737373'>
                            <img style="height: 100px;width: 150px" height="100" width="150" border=0
                                 id=""
                                 src='{{\Illuminate\Support\Facades\URL::asset("/images/product/".$product_info->id."/M/$image[0]")}}' alt=Dibdaa>
                    <o:p></o:p></span></p>
            </td>
            <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              word-wrap: break-word'>
