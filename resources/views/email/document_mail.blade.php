...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
      ...
      color:white;font-weight:normal'>Dear <?php echo $name; ?>,<o:p></o:p></span></h1>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'>
        ...
        line-height:130%;font-family:"Calibri","sans-serif";'>
                        ...
                        Please find attached a copy of your user agreement/user privacy statement agreed on <?php echo date('D-M-d,Y',strtotime($date)); ?>.
                        <o:p></o:p></span></h2>
