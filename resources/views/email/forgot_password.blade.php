<div style="font-family:sans-serif">
    ...
    <?php
      ...
      $link="<a href=\"$config/set-password?q=$param \">click this link</a>";

      $searchArray = array("USER_NAME", "LINK");
      $replaceArray = array($name,$link);
      ...
      ?>
    {{--<p>Please <a href="http://localhost:8100/#/set-password?q={{ $param }}">click this link</a> to set new password for your account.</p>--}}
