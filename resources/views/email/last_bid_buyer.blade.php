...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
      ...
      color:white;font-weight:normal'> <?php
                                        ...
                                        $your_bid=$product_info->your_bid;
                                        $end_time=$product_info->days_left;
                                        $link="<a href=\"$config/#/viewItem/$product_info->id \">$product_title</a>";
                                        $button_link="<a href=\"$config/#/viewItem/$product_info->id \">CLICK TO BID</a>";
                                        $searchArray = array("FIRST_NAME", "BID_PRICE","PRODUCT_LINK","BID_BUTTON","YOUR_BID","END_TIME");
                                        $replaceArray = array($first_name,$offer_price,$link,$button_link,$your_bid,$end_time);
