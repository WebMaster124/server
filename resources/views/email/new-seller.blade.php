<div style="font-family:sans-serif">
    ...
    $verify_link="<a href=\"$config/check-otp?q=$param \">Verify Now</a>";
    $contact_link="<a href=\"$config/contact-us\">Contact US</a>";

    $searchArray = array("RANDOM_NUMBER", "VERIFY_NOW_LINK", "CONTACT_US_LINK");
    $replaceArray = array($rand_no,$verify_link,$contact_link);
