...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
        ...
        <tr>
            <td>
                <div align=center>
                    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=600
                           ...
                           id="template_header">
                        <tr>
                            @if($product_info->offer_status=='Accept')
          ...
          color:white;font-weight:normal'> Dear   {{ $buyer_info->first_name }},<o:p></o:p></span></h2>
          
          
           <h2 style='margin:0in;margin-bottom:.0001pt;line-height:150%;text-shadow:
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                                style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Your offer on item  {{ $product_info->title  }}  has been accepted and you have purchased the items as per the terms of Dibdaa agreed when you signed up.  <o:p></o:p></span></h2>
        
         <a  href="{{ $link }}"><button style=" padding: 10px;  background-color:#584c57;color:white; width:100px; ">Buy Now</button></a>
        
                                  
                                 <!--   <h2 style='margin:0in;margin-bottom:.0001pt;line-height:150%;text-shadow:
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                                style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Your offer request for {{ $product_info->title  }} is {{$product_info->offer_status}} <o:p></o:p></span></h2> !-->
                               <!--     <h3 style='margin:0in;margin-bottom:.0001pt;line-height:150%;text-shadow:
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                                style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Your offer price is {{$product_info->offer_price}} <o:p></o:p></span></h3>
                                    <h3 style='margin:0in;margin-bottom:.0001pt;line-height:150%;text-shadow:
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                                style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Please, place your order. <o:p></o:p></span></h3> !-->
                                </td>
                             ...
                             @else
                              <!-- <td style='padding:27.0pt .5in 27.0pt .5in; color:' id="header_wrapper">
                                <h2 style='margin:0in;margin-bottom:.0001pt;line-height:150%;text-shadow:
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                            style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Your offer request for {{ $product_info->title  }} is {{$product_info->offer_status}} <o:p></o:p></span></h2>
          ...
          0 1px 0 #F47321;-webkit-font-smoothing: antialiased'><span
                                                style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
          color:white;font-weight:normal'> Unfortunately your offer of  for item {{ $product_info->title  }}  was not successful.  However don’t let this stop you. Make another offer now. Remember you only have 3 chances to submit an offer to the seller for this item. After this time you will need to pay the asking price. This is offer 1 of 3. You have 2 offer opportunities left.  <o:p></o:p></span></h2>
        
          <a  href="{{ $link }}"><button style="background-color:#584c57;color:white; width:100px; padding: 10px; ">Buy Now</button></a>
          
            <a  href="http://onlinetnt.com/#/viewItem/<?php echo $product_info->id;?> "><button style="background-color:#584c57;color:white;  width:150px; padding: 10px;  "> Make New Offer</button></a>
