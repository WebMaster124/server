...
<table class=MsoNormalTable border=1 cellspacing=0
    ...
    <tr>
        <td colspan=2
            style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
            <p class=MsoNormal><b><span style='font-family:"Calibri","sans-serif";
          color:#737373'>Payment Type:<o:p></o:p></span></b></p>
        </td>
        <td style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
            <p class=MsoNormal><span
                        class=woocommerce-price-currencysymbol><span
                            style='font-family:"Calibri","sans-serif";color:#737373'>{{($email_template->order_status=='unpaid'?'Cash On Delivery':'PayPal')}} </span></span></p>
        </td>
    </tr>
    <tr>
        <td colspan=2
        ...
        <td style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
          ...
          color:#737373'>
                            ...
                            if ($coupon_code->code_type == 'Flat Discount') {
                                echo  $total = $total - $coupon_code->discount;
                            } else {
                                $code_discount = $total * ($coupon_code->discount * $cnt) / 100;
                                echo  $total = $total - $code_discount;
                            }
                            ?>
                        @else
                            {{$total}}
