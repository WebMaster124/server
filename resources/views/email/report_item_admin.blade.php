   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
        ...
        <tr>
            <td>
              ...
              color:white;font-weight:normal'>Product reported by the {{$user_info->first_name}} {{$user_info->last_name}} ({{$user_info->display_name}}) <o:p></o:p></span></h3>
...
<div align=center>
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
        ...
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'> <b> Report Category </b> : {{$user_info->report_reasons[0]}}<o:p></o:p></span></p>

                <p style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:12.0pt;
        margin-left:0in;line-height:150%'><span style='font-size:12.5pt;
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'> <b> Reason for Report </b>: {{$user_info->report_reasons[1]}}<o:p></o:p></span></p>

                <p style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:12.0pt;
        margin-left:0in;line-height:150%'><span style='font-size:12.5pt;
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'><b>Detailed Reason </b> : {{$user_info->report_reasons[2]}}<o:p></o:p></span></p>

                <p style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:12.0pt;
        margin-left:0in;line-height:150%'><span style='font-size:12.5pt;
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'> <b> Other Reason </b>: {{$user_info->reason}}<o:p></o:p></span></p>
            </td>
        </tr>
    </table>
    ...
    <table class=MsoNormalTable border=1 cellspacing=0
        ...
        <tr>
           ...
           color:#737373'>Image<o:p></o:p></span></b></p>
            ...
            <td style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
                <p class=MsoNormal><b><span style='font-family:"Calibri","sans-serif";
           color:#737373'>Item Number<o:p></o:p></span></b></p>
            </td>
            <td style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
                <p class=MsoNormal><b><span style='font-family:"Calibri","sans-serif";
        ...
        <tr>
            <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              ...
              color:#737373'>
                        <a href="{{config('app.url')}}public/index.php/view-product-details/{{$product_info->id}}" >
            ...
            <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              word-wrap: break-word'>
                <p class=MsoNormal><span style='font-family:"Calibri","sans-serif";
              color:#737373'>{{$product_info->product_sku}}
                        <o:p></o:p></span></p>
            </td>
            <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              word-wrap: break-word'>
