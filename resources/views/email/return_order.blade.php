...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
      ...
      color:white;font-weight:normal'>
                                        ...
                                        Please Agreed in order to cancel {{$user_info->first_name}}  recent purchase
                                       <!-- {{$user_info->first_name}} Generate ticket #{{ $ticket_id }} !-->
                                        @elseif($status=='reply')
                                         {{$seller->first_name}} reply  ticket #{{ $ticket_id }}
                                        @else
    ...
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
        ...
        <tr>
            <td valign=top style='padding:.5in .5in 0in .5in'>
                  ...
                  <h3 ><span style='font-size:13.0pt;
        line-height:130%;font-family:"Calibri","sans-serif";color:black'>Hello {{$seller->first_name}},
        :<o:p></o:p></span></h3>
                
                 <h3 ><span style='font-size:13.0pt;
        line-height:130%;font-family:"Calibri","sans-serif";color:black'>{{$user_info->first_name}} recently opened a ticket to cancel a transaction for an item
                          recently purchased,  Order are shown below for your reference:
        :<o:p></o:p></span></h3>
                <h3 ><span style='font-size:13.0pt;
        line-height:130%;font-family:"Calibri","sans-serif";color:#F47321'>Order Details
        :<o:p></o:p></span></h3>
                @if($status=='request')
        ...
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'>{{$user_info->first_name}} want to return  your
        products,  Order
        details are shown below for your reference:<o:p></o:p></span></p> !-->
                @else
                    <p style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:12.0pt;
        margin-left:0in;line-height:150%'><span style='font-size:12.5pt;
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'>{{$seller->first_name}} replay for your request,  Order
        details are shown below for your reference:<o:p></o:p></span></p>
                @endif
        ...
        #{{ $ticket_id }} <o:p></o:p></span></h2>
                <h2 style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:13.5pt;
        margin-left:0in;line-height:130%'><span style='font-size:14.5pt;
        line-height:130%;font-family:"Calibri","sans-serif";color:#F47321'>Order id :
        #{{ $order_id }} <o:p></o:p></span></h2>
                <h2 style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:13.5pt;
        margin-left:0in;line-height:130%'><span style='font-size:14.5pt;
        line-height:130%;font-family:"Calibri","sans-serif";color:#F47321'>Reason :
         {{ $reason }} <o:p></o:p></span></h2>
                <div style='margin-bottom:30.0pt'>
                    <h3 style='margin:0in;margin-bottom:.0001pt;line-height:150%;-webkit-font-smoothing: antialiased'><span style='font-size:13.5pt;line-height:150%;font-family:"Calibri","sans-serif";
      color:black;font-weight:normal'>Note : To reply please log on  dibdaa and go to my activity > queries.<o:p></o:p></span></h3>
                </div>
            </td>
        </tr>
    </table>
...
<div align=center>
    <table class=MsoNormalTable border=1 cellspacing=0
        ...
        @foreach($product_info as $product)
            ...
            <?php   $product->photos=unserialize($product->photos); ?>
            <tr>
              ...
              color:#737373'>
                            <img style="height: 100px;width: 150px" height="100" width="150" border=0
                                 id=""
                                 src='{{\Illuminate\Support\Facades\URL::asset("/images/product/".$product->id."/M/".$product->photos[0])}}' alt=Dibdaa>
                    <o:p></o:p></span></p>
                </td>
                <td style='border:solid #EEEEEE 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt;
              word-wrap: break-word'>
        ...
        <tr>
          ...
          color:#737373'>User Information:<o:p></o:p></span></b></p>
            ...
            <td colspan=3 style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
