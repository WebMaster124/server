...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'
      ...
      color:white;font-weight:normal'>
                                         @if($status=='request')
                                            {{$seller->first_name}} Generate ticket #{{ $ticket_id }}

                                        @elseif($status=='reply')
                                            {{$user_info->first_name}} reply  ticket #{{ $ticket_id }}
                                        @else
...
<div align=center>
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
        ...
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'>{{$seller->first_name}} Generate ticket for {{ $reason }},  Order
        details are shown below for your reference:<o:p></o:p></span></p>
                @else
                    <p style='mso-margin-top-alt:0in;margin-right:0in;margin-bottom:12.0pt;
        margin-left:0in;line-height:150%'><span style='font-size:12.5pt;
        line-height:150%;font-family:"Calibri","sans-serif";color:#737373'>{{$user_info->first_name}} replay for your request,  Order
        details are shown below for your reference:<o:p></o:p></span></p>
                @endif--}}
        ...
        line-height:130%;font-family:"Calibri","sans-serif";color:#F47321'>Reason :
                ...
                <div style='margin-bottom:30.0pt'>
                    ...
                    <h3 style='margin:0in;margin-bottom:.0001pt;line-height:150%;-webkit-font-smoothing: antialiased'><span style='font-size:22.5pt;line-height:150%;font-family:"Calibri","sans-serif";
      color:black;font-weight:normal'>To reply please log on  dibdaa and go to my activity > queries.<o:p></o:p></span></h3>
                </div>
            </td>
        </tr>
    </table>
...
<div align=center>
    <table class=MsoNormalTable border=1 cellspacing=0
        ...
        <tr>
            <td style='border:solid #E4E4E4 1.0pt;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
                <p class=MsoNormal><b><span style='font-family:"Calibri","sans-serif";
          color:#737373'>Seller Information:<o:p></o:p></span></b></p>
            </td>
          ...
          padding:9.0pt 9.0pt 0in 9.0pt'>
                    <address
                            style='border:none;padding:0in'><span
                                style='color:#737373'>{{$seller->display_name}}
                            <br>
          ...
          margin-left:0in;border:none;padding:0in'><i><span style='color:#737373'> {{$seller->email}}
                                <o:p></o:p></span></i>
                    </p>
                </div>
            </td>
