...
//                                          $searchArray = array("PRODUCT_LINK");
//                                          $replaceArray = array($link);
//
//                                          echo html_entity_decode(str_replace($searchArray,$replaceArray,$email_template->heading));
                                          
                                          $searchArray = array("first_name", "last_name", "user_name", "product_title");
                                        $replaceArray = array($user_info->first_name,$user_info->last_name,$user_info->display_name,$product_info->title);
