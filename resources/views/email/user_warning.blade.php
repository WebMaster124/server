            ...
            <div id="template_header_image">
                <p align=center style='margin-top:0in;text-align:center;margin-bottom:10px'>
                    <a href="index.html"  target="_blank">
                        <img border=0   id="_x0000_i1025" src="{{\Illuminate\Support\Facades\URL::asset('/images/Dibdaa.png')}}" alt=Dibdaa>
                    </a>
                    <o:p></o:p>
                </p>
            </div>
...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important' id="template_container">
      ...
      color:white;font-weight:normal'>
                                        <?php echo str_replace('REASON',$warning,$email_template->heading); ?><o:p></o:p></span></h1>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div align=center>
   ...
   box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;border-radius: 3px !important'>
        ...
        line-height:130%;font-family:"Calibri","sans-serif";'>
                        <?php echo str_replace('REASON',$warning,$email_template->content); ?>
                        <o:p></o:p></span></h2>
