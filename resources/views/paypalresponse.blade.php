        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <img class="success" alt="paypal" src="../images/white-check-mark-circle.png" width="55" height="55">
...
<!--                                <button type="submit" name="submit" id="checkout_Info" class="btn btn-primary">
                                    Paywith Paypal
                                </button>-->
<input name="submit" id="checkout_Info" type="image" src="https://www.paypalobjects.com/webstatic/en_US/i/btn/png/blue-rect-paypalcheckout-34px.png" value="PayPal" >
                            </div>
                        </div>
                    </form>
                </div>
